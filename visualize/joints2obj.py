...
if __name__ == '__main__':
    '''
    python -m visualize.joints2obj
    '''
    simplify = joints2smpl(device_id=0, cuda=True, num_frames=1)
    ...
    f = '/apdcephfs/private_yyyyyyyang/code/mdm/save/my_v2_0/model000400000/result_rec.npy'
    simplify.npy2smpl(f)
