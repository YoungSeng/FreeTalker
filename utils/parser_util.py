...
def add_base_options(parser):
    ...
    group.add_argument("--n_frames", default=190, type=int, help="Batch size during training.")
    group.add_argument("--n_seed", default=20, type=int)
    group.add_argument("--split_para", default=1, type=int)
    group.add_argument("--torch_manual_seed", default=1234567, type=int)
    group.add_argument("--guidacnce_param", default=0, type=float)
    group.add_argument("--h5file_path", default="/apdcephfs/private_yyyyyyyang/code/mdm/prcocessed_data/v3_train.h5", type=str)
    group.add_argument("--statistics_path", default="/apdcephfs/private_yyyyyyyang/code/mdm/prcocessed_data/", type=str)
...
def add_model_options(parser):
    ...
    group.add_argument("--lambda_vel_rcxyz", default=0.0, type=float, help="Joint positions loss.")
