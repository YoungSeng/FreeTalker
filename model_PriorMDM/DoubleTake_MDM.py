...
from model_PriorMDM.rotation2xyz import Rotation2xyz

from model_PriorMDM.mdm import MDM      # TypeError: __init__() got multiple values for argument 'batch_size'
...
class doubleTake_MDM(MDM):
    ...
    def __init__(self, modeltype, njoints, nfeats, num_actions, translation, pose_rep, glob, glob_rot,
        ...
        #                                         self.nfeats)
        self.rot2xyz = Rotation2xyz(device='cpu', dataset=self.dataset, batch_size=kargs.get('batch_size', None))        # kargs.get('batch_size', None)
