...
def convert_mdm_mp4_to_amass_npz(skeleton_movie_fname, out_fname=None, save_render=False, comp_device='cuda:0',
    ...
    if osp.exists(out_fname):
        ...
        transformed_d = transform_smpl_coordinate(bm_fname=bm_fname, trans=d['trans'], root_orient=d['root_orient'],
                                                  betas=d['betas'], rotxyz=[0, 0, 0])      # [90, 0, 0]
...
if __name__ == '__main__':
    ...
    python motion2smplx.py --input /apdcephfs/private_yyyyyyyang/tmp/123456.npy --output /apdcephfs/private_yyyyyyyang/tmp/123456.npz
    python motion2smplx.py --input /apdcephfs/private_yyyyyyyang/tmp/2_scott_0_75_75.npy --output /apdcephfs/private_yyyyyyyang/tmp/2_scott_0_75_75.npz
    python motion2smplx.py --input /apdcephfs/private_yyyyyyyang/tmp/2_scott_0_75_75_rec_ric_data.npy --output /apdcephfs/private_yyyyyyyang/tmp/2_scott_0_75_75_rec_ric_data.npz
    '''
    import argparse
    from glob import glob
